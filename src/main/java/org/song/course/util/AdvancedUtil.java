...
import org.song.course.pojo.SNSUserInfo;
import org.song.course.pojo.WeixinGroup;
import org.song.course.pojo.WeixinMedia;
import org.song.course.pojo.WeixinOauth2Token;
import org.song.course.pojo.WeixinQRCode;
import org.song.course.pojo.WeixinUserInfo;
import org.song.course.pojo.WeixinUserList;
...
public class AdvancedUtil {
	...
	public static void main(String args[]) {
		// 获取接口访问凭证
		String accessToken = CommonUtil.getToken("wxd50d4dbeb2ce2f24", "9aec6e257c5ce2aeab9234f8a32a10d7").getAccessToken();

//		/**
//		 * 发送客服消息（文本消息）
//		 */
//		// 组装文本客服消息
//		String jsonTextMsg = makeTextCustomMessage("o0MrivgRfILFGnC0kyZvzv23cAOU", "点击查看<a href=\"http://blog.csdn.net/lyq8479\">柳峰的博客</a>");
//		String jsonTextMsg = makeTextCustomMessage("o0MrivgRfILFGnC0kyZvzv23cAOU", "测试客服消息");
////		// 发送客服消息
...
//		list.add(article2);
//		// 组装图文客服消息
//		String jsonNewsMsg = makeNewsCustomMessage("o0MrivgRfILFGnC0kyZvzv23cAOU", list);
//		// 发送客服消息
...
//
		 ...
		 * 根据ticket换取二维码
		 */
//		String ticket = "gQHL8ToAAAAAAAAAASxodHRwOi8vd2VpeGluLnFxLmNvbS9xLzMwV1BtOVBrWEdVbGQ5akJibXNVAAIEz7C6VwMEhAMAAA==";
...
//		 * 获取用户信息
//		 */
//		WeixinUserInfo user = getUserInfo(accessToken, "o0MrivgRfILFGnC0kyZvzv23cAOU");
