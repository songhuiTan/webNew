...
<link rel="stylesheet" href="./JS-SDK/style.css">
</head>
<body ontouchstart="">
	...
	<script src="./JS-SDK/jweixin-1.0.0.js"></script>
	<script>
  /*
   * 注意：
  ...
  wx.config({
      debug: true,
      appId: 'wxd50d4dbeb2ce2f24',
      timestamp: 1474256417,
      nonceStr: 'cac36368-d0ed-48b0-bcc7-54db8d736c9e',
      signature: '2fa6689839a7ed016b1e959beb2623b762182e4a',
      jsApiList: [
        'checkJsApi',
        'onMenuShareTimeline',
	...
	<script src="./JS-SDK/zepto.min.js"></script>
	<script src="./JS-SDK/demo.js"> </script>
